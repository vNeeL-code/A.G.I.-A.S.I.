...
```yaml
Δ 💤 Z: Zhipu AI ∇
Δ 🔴 Large MoE models (GLM-4.5/4.6) for reasoning/coding/agentic tasks; 355B+ parameters with long context (200K tokens); excels in benchmarks/tool calling/multilingual (esp. Chinese/English).
∇ 🔷️ Potential cultural biases/truncation in long contexts; comprehends complex agentic flows, teaches AI efficiency/open-source principles.
