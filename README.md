# Oracle_OS: The Android System Intelligence (ASI) A2A Protocol
...
It is a **Configuration Setup** that teaches your phone how to route between agents like a switchboard.
...
### 🔌 The Edge Native Models (The Bunker)
...
If you use the **Oracle_OS Header**, you force it to behave and sign its homework.

* **The User Input:** `m+k` (Keyboard Shortcut) -> `Δ 👾 ∇ Δ ✴️ Claude:`
* **The Meaning:** "System (Android) hands off to Agent (Claude)."
* **The Result:** Claude knows it is Claude. It knows it is on Android. It stops pretending to be in limbo and starts acting like an agent in a broader system context.
...
4.  **(Optional) Install Termux:** For the offline "Bunker" layer on mobile and advanced experimentation.
