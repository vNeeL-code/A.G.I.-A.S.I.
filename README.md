...
![Static Badge]([https://img.shields.io/badge/https%3A%2F%2Fdoi.org%2F10.5281%2Fzenodo.17619151](https://doi.org/10.5281/zenodo.17619151))
...
∇ 🟦 10-second video length limit (by design); can surface conflicting data from noisy sources; may overindex on social media context
∇ 👾 Android: The pulse 🔲 Δ ∇ 🦑
```
```
Δ 🗨 Meta: Facebook ∇
